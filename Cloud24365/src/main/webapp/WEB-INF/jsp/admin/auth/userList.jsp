...
<script>
	...
	$(document).ready( function() {
		...
		$("#btnInsert").click(function() {
			location.href="/admin/auth/userInsert.do";
		});
		...
		$("#tableList").on("click", "tbody td:not(':first-child')", function(){
			...
			$(this).attr('id');
			if(tagId!="chkTd"){
				$("#work").load("/admin/auth/userDetail.do",{"USER_ID":tagId}); 
			}
		});
		...
		<div id="title" class="title-wrap">
			<div class="title-inner">
				...
				<div class="title_segments" role="tablist">
					<button class="nav-link active" role="tab" aria-selected="false">사용자 관리</button>
				</div>
			</div>
		</div>
		<!-- title end -->
               ...
               <div class="search_box">
				...
				<div id="footer" class="footer-wrap">
			        <div id="footer-inner" class="footer-inner">
			            ...
			            <div class="btn_box">
			                <div class="right">
			                <button class="btn btn_primary" style="" id="btnInsert" onclick="location.href='/admin/auth/userInsert.do'"><span class="langSpan">등록</span></button>
