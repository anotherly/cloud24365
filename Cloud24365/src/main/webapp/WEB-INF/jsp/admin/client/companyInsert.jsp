...
<meta charset="UTF-8">
	...
	<script>
		$(document).ready(function() {
			...
			$('#datetimepicker1,#datetimepicker3,#datetimepicker4,#datetimepicker5').datetimepicker({
				 format:"YYYY-MM-DD",
				 //maxDate : maxD, 
				 defaultDate: defaultD
			 });
			//종료일의 경우 현재로부터 1달뒤로 설정 (변경될수있음)
			...
			$("#acDetailFrm").submit(function(e){
				...
				ajaxMethod('/admin/client/insertComapny.ajax',queryString,'/admin/client/companyList.do','저장되었습니다');
				location.href='/admin/client/companyList.do';
			}); 
    ...
    <div id="container" class="container-wrap">
		...
		<div id="contents" class="contents-wrap list_ani">
			...
			<div id="work" class="work-wrap">
				...
				<form name="insertForm" id="acDetailFrm" method="post" action="/admin/client/companyList.do"  enctype="multipart/form-data">
				<div id="contents_box" class="contents_box">
					<!-- 컨텐츠 테이블 헤더 Start -->
					<div class="ctn_tbl_header">
						<div class="ttl_ctn" data-term="L.위협정보_등록" title="위협정보 등록">
							<span class="langSpan">고객 등록</span>
						</div>
						<!-- 컨텐츠 타이틀 -->
					        ...
					        <div id="footer-inner" class="footer-inner">
					            ...
					            <div class="btn_box">
					                <div class="right">
							            ...
							            <button type="button" class="btn" id="btnList" data-term="L.목록" title="목록" onclick="location.href='/admin/client/companyList.do'"><span class="langSpan">취소</span></button>
					                </div>
					            </div>
					            <!-- btn_box End -->
					        </div>
