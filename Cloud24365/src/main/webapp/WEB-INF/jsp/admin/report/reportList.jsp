...
<script>
	...
	$(document).ready( function() {
		...
		var tb2=$("#tableList").DataTable({
			ajax : {
                "url":"/admin/report/reportList.ajax",
                "type":"POST",
                "dataType": "json",
            },  
            columns: [
	...
	function search(){
		 ...
		 if(listArr.length==0){
			 ...
			 frm+="&listArr="+listArr;
			 var tagUrl="/admin/report/reportList.ajax";
...
<body class="open">
    ...
    <div id="container" class="container-wrap">
		...
		<div id="title" class="title-wrap">
			<div class="title-inner">
				...
				<div class="title_segments" role="tablist">
					<button class="nav-link active" role="tab" aria-selected="false">보고서관리</button>
				</div>
			</div>
		</div>
		<!-- title end -->
		...
		<div id="contents" class="contents-wrap list_ani">
			...
			<div class="btn_box">
				<div class="right">
					<button class="btn btn_primary" id="btnDownload" onclick="location.href='/admin/report/excelDownload.ajax'">
			...
			<div id="footer" class="footer-wrap">
		        <div id="footer-inner" class="footer-inner">
		            ...
		            <div class="btn_box">
		                <div class="right">
		                    <button class="btn btn_primary" style="" id="btnInsert" onclick="location.href='/admin/report/reportInsert.do'"><span class="langSpan">등록</span></button>
