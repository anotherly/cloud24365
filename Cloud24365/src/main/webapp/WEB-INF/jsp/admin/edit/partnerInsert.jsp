...
<script>
	...
	$(document).ready( function() {
		...
		$("#acDetailFrm").submit(function(e){
		    ...
		    var options = {
	            url:'/admin/edit/insertPartner.ajax',
	            type:"post",
	            dataType: "json",
	            ...
	            success: function(res){
	                if(res.cnt > 0){
	                    alert("저장되었습니다.");
	                    location.href="/admin/edit/client.do"
	                } else {
	...
	<form name="insertForm" id="acDetailFrm" method="post" enctype="multipart/form-data"  action="/admin/edit/client.do" >
