		...
		$(document).ready(function() {
			...
			$("#loginForm").submit( function(event){
				...
				//if(boardWriteCheck(form)){
					$.ajax({
						url: "/client/setting/account/chkPw.ajax",
						type: "POST",
						dataType: "json",
						data: queryString,
						// ajax 통신 성공 시 로직 수행
		...
		<div id="subCir" class="sub-cir-div" style="width:800px;height:600px;">
			<form id="loginForm" name="loginForm" method="post" enctype="multipart/form-data">
				...
				<table class="semi-tb" border="1" align="center">
					<tbody>
						...
						<tr>
							<td>신규 비밀번호</td>
							<td>
								<input type="password" id="USER_PW1" name="USER_PW1" maxlength="15" onkeyup="spaceChk(this);" onkeydown="spaceChk(this);"  required>
							</td>
						</tr>
					</tbody>
				</table>
				<div class="btnDiv">
					...
					<button id="btnCancel" class="buttonDf">취소</button>
				</div>
			</form>	
		</div>
	</div>
