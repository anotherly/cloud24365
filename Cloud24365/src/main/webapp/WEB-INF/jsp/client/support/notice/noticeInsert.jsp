	...
	<script>
		$(document).ready(function() {
			...
			$("#acDetailFrm").submit(function(e){
			    ...
			    var options = {
		            url:'/client/support/notice/insertNotice.ajax',
		            type:"post",
		            dataType: "json",
...
<body class="open">
    ...
    <div id="container" class="container-wrap">
		...
		<div id="contents" class="contents-wrap">
			...
			<form name="insertForm" id="acDetailFrm" method="post" action="/client/support/notice/noticeList.do"  enctype="multipart/form-data">
                <!-- contents_box Start -->
                    ...
                    <div id="footer-inner" class="footer-inner">
                        ...
                        <div class="btn_box">
                            <div class="right">
					            ...
					            <button type="button"  class="btn" id="btnList" data-term="L.목록" title="목록" onclick="location.href='/client/support/notice/noticeList.do'">
