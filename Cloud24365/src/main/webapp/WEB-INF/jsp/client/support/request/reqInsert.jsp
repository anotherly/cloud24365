	...
	<script>
		$(document).ready(function() {
			...
			$("#btnSave").on("click",function(){
			    ...
			    var options = {
		            url:'/client/support/request/reqInsert.ajax',
		            type:"post",
		            dataType: "json",
                    ...
                    <div class="ctn_tbl_area">
                        ...
                        <div class="ctn_tbl_row">
                            ...
                            <div class="ctn_tbl_td">
                                <input type="text" class="form-control mw_50" id="REQ_TITLE" name="REQ_TITLE" value="${reqVo.REQ_TITLE}"/>
                            </div>
                        </div>
						<div class="ctn_tbl_row">
                        ...
                        <div class="ctn_tbl_row">
                            ...
                            <div class="ctn_tbl_td">
                                <textarea id="REQ_QUESTION" name="REQ_QUESTION" class="long-cont" style="height:470px;"></textarea>
                            </div>
                        </div>
                    </div>
                    </form>
