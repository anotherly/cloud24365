			           ...
			           <div class="right">
				           <c:choose>
					           <c:when test="${reqVo.REQ_STATUS==0}">
									<button type="button"  class="btn btn_primary" style="background:darkgray; color:lightgray;" ><span class="langSpan">미접수</span></button>
					           </c:when>
					           <c:when test="${reqVo.REQ_STATUS==1}">
									<button type="button"  class="btn btn_primary" style="background:darkgray; color:lightgray;" ><span class="langSpan">확인중</span></button>
					           </c:when>
					           <c:when test="${reqVo.REQ_STATUS==2}">
